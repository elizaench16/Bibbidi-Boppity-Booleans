...
function setUsername() {
  ...
  document.getElementById("next-option").innerHTML = "<h3 id=\"button-label\">Where next?</h3> <button onclick=\"location.href= '/Floors/floor1A.html';\">Start Adventure</button> <button onclick=\"location.href='/index.html';\" value=\"Home\">Home</button>";
}
